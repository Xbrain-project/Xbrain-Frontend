...
const Hero = () => {
  return (
    // home bg
    <div className="bg-[#F9F871] mt-0 pt-0 ">
      <div className="mx-auto py-24 flex flex-col-reverse relative md:flex-row md:justify-center md:gap-8 md:items-center xl:gap-24">
        {/* left side */}
